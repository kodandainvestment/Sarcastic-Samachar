...
const Navbar = () => {
  ...
  return (
    ...
    >
      {/* Top bar */}
      <div className="max-w-7xl mx-auto relative flex items-center py-2 px-6 xl:px-14">
        {/* Logo */}
        ...
        <div className="hidden lg:flex ml-auto">
          ...
          >
            <motion.span
              ...
              style={{
                background: "linear-gradient(90deg, rgb(222,207,151), rgb(250,242,214), rgb(222,207,151))",
                padding: "2px",
            ...
            />
            <span className="relative block px-4 py-[4px] rounded-full" style={{ background: "rgb(30,28,32)" }}>
              <span
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            <div className="flex flex-col gap-0 pb-4 pt-2 px-6">
              {NAV_LINKS.map((link) => (
                <button
                  key={link.href}
